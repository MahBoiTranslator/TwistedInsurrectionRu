...
2. Описание установки:
	...
	вставьте текст **ModMode=True**. Если у вас процессор старого поколения, то настоятельно рекомендую 
	перед началом сетевой игры удалить/переименовать/переместить файл LangFS.ini 
	(можно делать даже с уже запущенным клиентом), находящийся в папке ПапкаИгры\INI, т.к. он зачастую 
