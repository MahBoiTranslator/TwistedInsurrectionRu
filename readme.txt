...
4. Прочая информация:
	При сетевой игре лучше не использовать файл LangFS.ini, т.к. он часто вызывает рассинхронизацию. Можете переименовать его, к
	примеру. Это было выявлено в ходе множества попыток сетевой игры.
